    ...
    li.innerHTML = `
        <div class="p-8 border border-ash/10 rounded-xl space-y-4">
          <h2 class="text-xl font-bold text-ash">
            ${donateAmount} Taka is donated for ${donateLocation};
          </h2>
          <p class="text-ash/70">
...
document.getElementById('history').addEventListener('click', function(){
    document.getElementById('history').classList.add('bg-primary', 'py-3', 'px-8', 'rounded-lg', 'text-ash', 'font-bold', 'text-xl')
    document.getElementById('donation').classList.remove('bg-primary', 'py-3', 'px-8', 'rounded-lg', 'text-ash', 'font-bold', 'text-xl')
    document.getElementById('donation').classList.add('border-2', 'border-ash/30', 'py-3', 'px-8', 'rounded-lg', 'text-ash/70', 'font-bold', 'text-xl')
    document.getElementById('donation-section').classList.add('hidden');
    document.getElementById('history-section').classList.remove('hidden');
})
document.getElementById('donation').addEventListener('click', function(){
    document.getElementById('history').classList.remove('bg-primary', 'py-3', 'px-8', 'rounded-lg', 'text-ash', 'font-bold', 'text-xl')
    document.getElementById('donation').classList.add('bg-primary', 'py-3', 'px-8', 'rounded-lg', 'text-ash', 'font-bold', 'text-xl')
    document.getElementById('history').classList.add('border-2', 'border-ash/30', 'py-3', 'px-8', 'rounded-lg', 'text-ash/70', 'font-bold', 'text-xl')
